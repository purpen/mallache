      ...
      <el-col :span="5">
        <div class="progress">
          ...
          <div class="process-item">
            <p>项目对接</p>
            <el-steps :space="50" direction="vertical" finish-status="process" :active="progressButt">
          ...
          <div class="process-item">
            <p>合同管理</p>
            <el-steps :space="50" direction="vertical" finish-status="process" :active="progressContract">
  ...
  created: function() {
    ...
    .then (function(response) {
      if (response.data.meta.status_code === 200) {
        ...
        var typeLabel = ''
        if (self.item.type === 1) {
          typeLabel = self.item.type_value + '/' + self.item.design_type_value + '/' + self.item.field_value + '/' + self.item.industry_value
        } else {
          typeLabel = self.item.type_value + '/' + self.item.design_type_value
        }
