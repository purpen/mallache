...
class UploadController extends BaseController
{
     ...
     * @apiParam {type} x:type 附件类型: 1.默认；2.用户头像；3.企业法人营业执照；4.需求项目设计附件；5.案例图片;6.设计公司logo；7.需求公司logo；8.项目阶段附件;9.需求公司营业执照；10.设计公司法人图片；11.需求公司法人证件;12.栏目位；13.文章封面；14.文章图片；16.趋势报告 17.趋势报告pdf；18.常用网站图片；25.奖项案例; 26.奖项案例编辑器； 28.系统通知图;29.沟通纪要附件;30. 报价单附件;31.阶段节点附件;32.线下合同文件；33银行转账凭证附件;34.子阶段/里程碑附件；35.阶段附件
     */
