...
class DesignCompanyController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(DesignCompanyModel $designCompanyModel)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, DesignCompanyModel $designCompanyModel)
    {
        //
    }
