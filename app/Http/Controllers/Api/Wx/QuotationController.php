...
{
    /**
     * @api {post} /wechat/quotationAdd  智能报价
     * @apiVersion 1.0.0
     * @apiName WxquotationAdd quotationAdd
     * @apiGroup Wx
     *
     * @apiParam {integer} type 设计类型：1.产品设计；2.UI UX 设计；3. 平面设计 4.H5 5.包装设计 6.插画设计
     * @apiParam {json} design_types 设计类别：产品设计（1.产品策略；2.产品设计；3.结构设计；）UXUI设计（1.app设计；2.网页设计；3.'界面设计', 4 . '服务设计', 5 . '用户体验咨询'）平面设计（1.'logo/VI设计', 2.'海报/宣传册', 3 .'画册/书装'）H5(1.H5) 包装设计（1.包装设计）插画（1. '商业插画', 2. '书籍插画', 3. '形象/IP插画'）
    ...
    public function quotationAdd(Request $request)
    {
        ...
        $payload = $request->only('type',  'design_types','level');
