    ...
    */
    ...
    public function transform(DesignCaseModel $designCase)
    {
        return [
            ...
            'system' => intval($designCase->system),
            'system_val' => $designCase->system_val,
            'design_content' => intval($designCase->design_content),
            'design_content_val' => $designCase->design_content_val,
