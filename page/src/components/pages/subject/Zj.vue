<template>
  <div class="content-box">
    ...
    <div class="bottom">
      ...
      <p class="content">消费升级的当下，传统产业通过设计升级转型是必然趋势，亦是创造下一个未来的必经之路。我们寻找有创意，有魄力，更对中国设计产业有使命感的设计公司，一起加入再造计划。同时，如果你有亟待改造升级的潜力项目，也可以加入我们。有意加入设计再造计划的有志之师，可发送参与意向至邮箱</p>
