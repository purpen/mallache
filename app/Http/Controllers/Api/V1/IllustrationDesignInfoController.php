...
use App\Models\IllustrationDesign;
use App\Models\Item;
...
class IllustrationDesignInfoController extends BaseController
{
    /*
    id	                int(10)	否
    item_id	            int(10)			项目ID
    ...
    */
    ...
    /**
     * @api {put} /IllustrationDesign/{item_id} 更改 插画详细信息
     * @apiVersion 1.0.0
     * @apiName demand update
     * @apiGroup demandIllustrationDesign
     *
     * @apiParam {json} design_types 插画（1. '商业插画', 2. '书籍插画', 3. '形象/IP插画'）
    ...
    public function update(Request $request, $item_id)
    {
        ...
        try {
            ...
            else if ((int)$item->type !== 6 || $item->user_id != $this->auth_user_id || 1 != $item->status) {
            ...
            $design = IllustrationDesign::firstOrCreate(['item_id' => intval($item_id)]);
            $design->update($all);
        } catch (\Exception $e) {
